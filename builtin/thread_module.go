...
// RegisterThreadModule registers the _thread module
// This is a minimal implementation to support basic threading operations
func RegisterThreadModule(ctx *core.Context) {
	...
	registry.StoreModule("_thread", threadModule, "<builtin>", []string{})
}
