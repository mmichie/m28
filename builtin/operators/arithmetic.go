...
// RegisterArithmeticOperators registers arithmetic operators in the context
func RegisterArithmeticOperators(ctx *core.Context) {
	...
	ctx.Define("**", core.NewBuiltinFunction(PowFunc))
}
